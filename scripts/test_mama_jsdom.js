    ...
    <div class="app-main">
      ...
      <main class="app-content">
        ...
        <div id="data-panels">
          ...
          <canvas id="chart-resultado"></canvas><canvas id="chart-mastografias"></canvas>
...
const totalReal = window.SNSP_REAL_DATA.cama_casos.total_casos;
console.assert(txt("kpi-grid").includes(String(totalReal)), `El KPI debería incluir ${totalReal}`);
console.log("Total real Mama:", totalReal, "-> aparece en KPI:", txt("kpi-grid").includes(String(totalReal)));
